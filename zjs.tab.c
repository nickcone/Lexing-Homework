...
static const char *const yytname[] =
{
  ...
  "list_of_expr", "expr", "command", "line", "point", "circle",
...
{
      -5,    -4,    -3,    -2,    -1,     0,     5,     8,    -5,     9,
      -6,    -6,    -6,    -6,    -6,     2,     4,     6,     7,    10,
      -6,    -6,    -6,    -6,    -6,    11,    12,    13,    14,    15,
      -6,    16,    -6,    -6,    -6
};
...
{
       1,     2,     3,     4,     5,    20,    15,    16,    17,    18,
      19,    21,    24,    23,    25,     0,    26,    27,     0,     0,
...
yyreduce:
  ...
  switch (yyn)
    {
        case 11:
#line 39 "zjs.y" /* yacc.c:1648  */
    {
	if ((yyvsp[-3].iVal) < 0 || (yyvsp[-3].iVal) > WIDTH){
		printf("LINE ERROR:x1 must be between 0-%d\n", WIDTH);
	}
	else if ((yyvsp[-2].iVal) < 0 || (yyvsp[-2].iVal) > HEIGHT){
		printf("LINE ERROR:y1 must be between 0-%d\n", HEIGHT);
	}
	else if ((yyvsp[-1].iVal) < 0 || (yyvsp[-1].iVal) > WIDTH){
		printf("LINE ERROR:x2 must be between 0-%d\n", WIDTH);
	}
	else if ((yyvsp[0].iVal) < 0 || (yyvsp[0].iVal) > HEIGHT){
...
#line 1247 "zjs.tab.c" /* yacc.c:1648  */
    break;

  case 12:
#line 56 "zjs.y" /* yacc.c:1648  */
    {
	if ((yyvsp[-1].iVal) < 0 || (yyvsp[-1].iVal) > WIDTH){
...
#line 1263 "zjs.tab.c" /* yacc.c:1648  */
    break;
...
#line 67 "zjs.y" /* yacc.c:1648  */
	...
	if ((yyvsp[-2].iVal) < 0 || (yyvsp[-2].iVal) > WIDTH){
		printf("CIRCLE ERROR:x must be between 0-%d\n", WIDTH);
	}
	else if ((yyvsp[-1].iVal) < 0 || (yyvsp[-1].iVal) > HEIGHT){
		printf("CIRCLE ERROR:y must be between 0-%d\n", HEIGHT);
	}
	else if ((yyvsp[0].iVal) < 0) {
...
#line 1283 "zjs.tab.c" /* yacc.c:1648  */
    break;

  case 14:
#line 82 "zjs.y" /* yacc.c:1648  */
    {
	...
	else if ((yyvsp[-1].iVal) < 0 || (yyvsp[-1].iVal) > WIDTH - (yyvsp[-3].iVal)){
		printf("RECTANGLE ERROR:width must be between 0-%d\n", WIDTH - (yyvsp[-3].iVal));
	}
	else if ((yyvsp[0].iVal) < 0 || (yyvsp[0].iVal) > HEIGHT - (yyvsp[-2].iVal)){
...
#line 1327 "zjs.tab.c" /* yacc.c:1648  */
    break;


#line 1331 "zjs.tab.c" /* yacc.c:1648  */
      default: break;
    }
